...
#lsizes = read.table("~/Documents/Research/MaizeSV/data/Lumpy_sizeNsamps_E2_p00_w300.txt", head=T)

lsum = lsizes %>% group_by(ref,stage,type) %>% summarize(n = n(), median = median(size)) %>% as.data.frame()

#Genome STRiP summary files -- OLD MQ10
...
gsizes = read.table("~/Documents/Research/MaizeSV/data/gstrip_MQ20_INFOfields.txt", head=T)
